...
public class SolveEquation {
	...
	public static void main(String[] args) {
		...
		int option;
		while (true) {
			System.out.println("Bao Phuc - Choose type of equation you wanna solve\n"
					+ "1: Linear equation\n"
					+ "2: System equation\n"
			...
			if(option == 1) {
				...
				System.out.println("Bao Phuc - Choose 1 from 3!");
			}
		}
	...
	private static void LinearEquation() {
		...
		double A, B, C;
		System.out.println("Bao Phuc-Enter coefficients:");
		...
		if (A == 0) {
			...
			System.out.println("Phuong trinh co nghiem:" + (C-B)/A);
		}
	}
	...
	private static void SystemEquation() {
		...
		System.out.println("Bao Phuc-Enter coefficients of the first equation:");
