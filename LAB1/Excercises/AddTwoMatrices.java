...
public class AddTwoMatrices {
	public static void main(String[] args) {
		...
		System.out.println("Bao Phuc-Enter rows of matric:");
		int row = scanner.nextInt();
		System.out.println("Bao Phuc-Enter columns of matric:");
		...
		System.out.println("Bao Phuc-Enter matrixA:");
		for(int i = 0; i<row; i++) {
		...
		System.out.println("Bao Phuc-Enter matrixB:");
		for(int i = 0; i<row; i++) {
			for (int j = 0; j<column; j++) {
